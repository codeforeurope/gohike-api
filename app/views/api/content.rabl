...
child :routes do
  ...
  child :waypoints do
    attributes :rank
    glue :location do
      attributes :id => :location_id, :name_en => :name_en, :name_nl => :name_nl, :description_en => :description_en, :description_nl => :description_nl, :latitude => :latitude, :longitude => :longitude
    end
    glue :route do
